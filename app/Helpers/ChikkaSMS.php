...
class ChikkaSMS {
    ...
    public function __construct(){
        $client_id = SiteConfig::where('key', 'CHIKKA_API_ID')->first();
        $secretKey = SiteConfig::where('key', 'CHIKKA_API_KEY')->first();
        $shortCode = SiteConfig::where('key', 'CHIKKA_SHORTCODE')->first();

        $this->clientId  = $client_id->value;
        $this->secretKey = $secretKey->value;
        $this->shortCode = $shortCode->value;
    }
    /**
